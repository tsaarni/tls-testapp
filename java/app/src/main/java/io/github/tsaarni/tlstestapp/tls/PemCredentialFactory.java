...
/**
 * Reads PEM files and constructs {@code Certificates} and {@code PrivateKeys}
 * from them.
 */
public class PemCredentialFactory {

    private static final Logger log = LogManager.getLogger(PemCredentialFactory.class);
    ...
    /**
     * Reads PEM encoded certificate or certificate bundle from given file and
     * constructs an array of {@code Certificates}.
     *
    ...
    /**
     * Reads PEM encoded private key (PKCS#8) from given file and construct
     * {@code PrivateKey}.
     *
     * @param path Path to PEM file.
     * @return Private key.
     ...
     * @return PrivateKey pointer if successful, null if private key could not be
     *         parsed as given algorithm.
     */
